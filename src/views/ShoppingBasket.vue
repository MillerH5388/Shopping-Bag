<template>
  <div class="basket">
    ...
    <template v-if="this.$store.state.productsInBag.length">
      <div class="items">

        <div class="item" v-for="(product, index) in this.$store.state.productsInBag" :key="index">
...
export default {
  ...
  methods: {
    orderTotal(){
      var total = 0
      this.$store.state.productsInBag.forEach(product => {
